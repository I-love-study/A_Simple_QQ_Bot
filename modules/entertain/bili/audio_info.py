...
async def audio_make(auid):
    ...
    font = ImageFont.truetype(r"static/font/SourceHanSansHW-Bold.otf", size=60)
    ...
    font = ImageFont.truetype(r"static/font/SourceHanSansHW-Bold.otf", size=40)
    bgd.text((600, 240), data["uname"], fill=(229, 229, 229), font=font)

    icon_font = ImageFont.truetype(r"static/font/bilibili-iconfont.ttf", size=45)
    bgd.multiline_text((420, 370), "\ue6e3\n\n\ue6e4\n\n\ue6e1",
             fill=(229, 229, 229), font=icon_font)
    font = ImageFont.truetype(r"static/font/SourceHanSansHW-Bold.otf", size=34)
    ...
    font = ImageFont.truetype(r"static/font/SourceHanSansHW-Bold.otf", size=25)
